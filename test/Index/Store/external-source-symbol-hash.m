...
- (void)method;
// CHECK: [[@LINE-1]]:9 | instance-method/Swift | c:@M@some_module@objc(pl)P1(im)method | Decl,Dyn,RelChild | rel: 1
@end
...
- (void)method;
// CHECK: [[@LINE-1]]:9 | instance-method/Swift | c:@M@other_module@objc(cs)I2(im)method | Decl,Dyn,RelChild | rel: 1
@end
